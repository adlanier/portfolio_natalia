...
const Home = () => (
  <div>
    ...
    <p>
      I am proficient in Python, Java/JavaScript, and React, with a solid background in full-stack web development and data analysis. Looking toward the future, I want to learn more about AI and ML applications and utilize them in my future projects.
    </p>
    <p>
      Apart from CS, I really enjoy thrifting, collecting vinyls, traveling, exercising, and have a strong appreciation for music and nature. I am a huge fan of Carolina basketball, Guayaki Yerba Mate, trying new foods, and the Oxford comma.
    </p>
  </div>
);
